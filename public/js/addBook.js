document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        if (!title || !author || price === '' || quantity === '' || isbn === '' || description === '') {
        ...
        if (data.success) {
            alert('Thêm sách thành công thông tin sách thành công!');
            window.location.href = 'http://localhost/gudbuk/admin-dashboard/store'; // RẤT DỄ BUG!!
        } else {
